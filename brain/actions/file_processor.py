"""
file_processor.py — MIA Universal File Processor
        ...
        def generate_content(self, contents):
            ...
            if isinstance(contents, str):
                ...
                for item in contents:
                    ...
                    elif isinstance(item, dict) and "data" in item:  # bytes dict
                        images_b64.append(base64.b64encode(item["data"]).decode('utf-8'))
            ...
            resp = self.client.chat(model=get_ollama_model(), messages=messages)
